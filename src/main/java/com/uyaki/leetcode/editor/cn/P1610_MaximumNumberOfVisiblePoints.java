...
// 
// Related Topics 几何 数组 数学 排序 滑动窗口 👍 31 👎 0
 ...
 * 可见点的最大数目
 */
public class P1610_MaximumNumberOfVisiblePoints {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P1610_MaximumNumberOfVisiblePoints().new Solution();
    }
