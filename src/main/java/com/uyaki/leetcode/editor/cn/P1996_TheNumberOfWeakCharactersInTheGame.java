...
// 
// Related Topics 栈 贪心 数组 排序 单调栈 👍 111 👎 0
 ...
 * 游戏中弱角色的数量
 */
public class P1996_TheNumberOfWeakCharactersInTheGame {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P1996_TheNumberOfWeakCharactersInTheGame().new Solution();
    }
